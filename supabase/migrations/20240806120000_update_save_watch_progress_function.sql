-- Update the function to include duration and a force history flag
...
BEGIN
    ...
    -- Add to watch history if progress is significant (e.g., > 15s), or if it's a rewatch, or forced
    -- A rewatch is detected if the new progress is much smaller than the old one.
